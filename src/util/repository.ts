import { Pokemon, PokemonMove } from "../model/pokemon";
import { Raid } from "../model/events";
import { BreakingNewsJson, PokemonJson, TypeJson, MoveJson } from "../model/json";
import { PokemonType, WeatherBoost } from "../model/type";
...
function getTypesArray(typesJsonArray: TypeJson[]): PokemonType[] {
